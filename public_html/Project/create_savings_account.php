...
<form method="POST">
    ...
    <input type="submit" name="submit" value="Create New Savings Account" />
</form>
...
function newQuery($uid, $acc_number, $prefix)
{
    try {
        $db = getDB();
        $stmt = $db->prepare("INSERT INTO Accounts (user_id, account_number, account_type) VALUES (:userid, :acc_number, 3)");
